...
const AdminBirthCertificate = () => {
  const [applications, setApplications] = useState([]);
  const apiUrl =
    "https://e-grampanchayat-jufy.onrender.com/api/birth-certificates";
  ...
  const fetchData = async () => {
    try {
      ...
      toast.error("Failed to fetch birth certificates");
    }
  };
  ...
  return (
    <div className={styles.panel}>
      <h3>Birth Certificate Applications</h3>
...
export default AdminBirthCertificate;
